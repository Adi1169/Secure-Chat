...
import com.example.securechat.User.UserListAdapter;
import com.example.securechat.User.UserObject;
import com.example.securechat.Utils.CountryToPhonePrefix;
                ...
                if(snapshot.exists()){
                    ...
                    for (DataSnapshot childSnapshot : snapshot.getChildren()){
                        ...
                        if (name.equals(phone)){
                            for (UserObject mContactsIterator : contactList){
                                if(mContactsIterator.getPhone().equals(mUser.getPhone())){
                                    mUser.setName(mContactsIterator.getName());
                                }
                            }
                        }
                        userList.add(mUser);
